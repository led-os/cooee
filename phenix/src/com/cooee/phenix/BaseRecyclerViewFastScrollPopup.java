...
public class BaseRecyclerViewFastScrollPopup
{
	...
	public BaseRecyclerViewFastScrollPopup(
			BaseRecyclerView rv ,
			Resources res )
	{
		mRes = res;
		mRv = rv;
		mBgOriginalSize = LauncherDefaultConfig.getDimensionPixelSize( R.dimen.container_fastscroll_popup_size );
		...
		mTextPaint.setTextSize( LauncherDefaultConfig.getDimensionPixelSize( R.dimen.container_fastscroll_popup_text_size ) );
	}
	 ...
	 */
	public Rect updateFastScrollerBounds(
			BaseRecyclerView rv ,
			int lastTouchY )
	{
