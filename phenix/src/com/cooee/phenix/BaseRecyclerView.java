...
public abstract class BaseRecyclerView extends RecyclerView implements RecyclerView.OnItemTouchListener
{
	...
	protected boolean isScrollBarVisible = true;//zhujieping add  //拓展配置项“config_applist_style”，添加可配置项2。2是7.0的主菜单样式。
			...
			int defStyleAttr )
	{
		...
		isScrollBarVisible = isHorizontalScrollBarEnabled() || isVerticalScrollBarEnabled();
		setVerticalScrollBarEnabled( false );//原先自带的scrollbar不显示，显示自己的mScrollbar
	 ...
	 */
	protected boolean shouldStopScroll(
			MotionEvent ev )
	{
	...
	{
		int visibleHeight = getHeight() - mBackgroundPadding.top - mBackgroundPadding.bottom;
		int availableScrollBarHeight = visibleHeight - ( mScrollbar != null ? mScrollbar.getThumbHeight() : 0 );
	 ...
	 */
	public int getFastScrollerThumbInactiveColor(
			int defaultInactiveThumbColor )
	{
	 ...
	 */
	public abstract String scrollToPositionAtProgress(
			float touchFraction );
	 ...
	 */
	protected abstract void getCurScrollState(
