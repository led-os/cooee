...
class OverviewPanelButtonKeyEventListener implements View.OnKeyListener
{
			...
			KeyEvent event )
	{
		...
		switch( keyCode )
		{
			...
			case KeyEvent.KEYCODE_DPAD_RIGHT:
				...
				{
					LinearLayout new_name = (LinearLayout)v;
					View childAt = new_name.getChildAt( 0 );
...
class FunctionPagesKeyEventListener implements View.OnKeyListener
{
	...
	public boolean onKey(
			...
			KeyEvent event )
	{
		return FocusHelper.handleFavoritesPageViewKeyEvent( v , keyCode , event );
	}
}
...
public class FocusHelper
{
	 ...
	 */
	private static TabHost findTabHostParent(
			View v )
	{
	 ...
	 */
	public static boolean handleAppsCustomizeTabKeyEvent(
			View v ,
			int keyCode ,
			KeyEvent e )
	{
	 ...
	 */
	private static ViewGroup getAppsCustomizePage(
			ViewGroup container ,
			int index )
	{
	 ...
	 */
	static boolean handlePagedViewGridLayoutWidgetKeyEvent(
			PagedViewWidget w ,
			int keyCode ,
			KeyEvent e )
	{
	 ...
	 */
	public static boolean handleAppsCustomizeKeyEvent(
			View v ,
			int keyCode ,
			KeyEvent e )
	{
	 ...
	 */
	static boolean handleTabKeyEvent(
			AccessibleTabView v ,
			int keyCode ,
			KeyEvent e )
	{
	 ...
	 */
	static boolean handleHotseatButtonKeyEvent(
			View v ,
			int keyCode ,
			KeyEvent e ,
			int orientation )
			...
			ViewGroup parent )
	{
		...
		Collections.sort( views , new Comparator<View>() {
			...
			public int compare(
					...
					View rhs )
			{
				if( !( lhs instanceof View && rhs instanceof View ) )
				{
					return 0;
				}
	 ...
	 */
	private static View findIndexOfIcon(
	...
	private static View getIconInDirection(
			CellLayout layout ,
			ViewGroup parent ,
			int i ,
			int delta )
			...
			KeyEvent e )
	{
		...
		final ViewGroup mSearchDropTargetBar = (ViewGroup)launcher.findViewById( R.id.search_drop_target_bar_id );
		...
		switch( keyCode )
		{
			...
			case KeyEvent.KEYCODE_DPAD_UP:
				if( handleKeyEvent )
				{
					...
					{
						mSearchDropTargetBar.requestFocus();
					}
				}
				break;
			case KeyEvent.KEYCODE_DPAD_DOWN:
	 ...
	 */
	public static boolean handleFolderKeyEvent(
			View v ,
			int keyCode ,
			KeyEvent e )
	{
	...
	/**
	 * Handles key events for FavoritesPageView.
	 */
	public static boolean handleFavoritesPageViewKeyEvent(
			View v ,
			int keyCode ,
			KeyEvent e )
	{
		...
		switch( keyCode )
		{
			case KeyEvent.KEYCODE_DPAD_LEFT:
				if( handleKeyEvent )
				{
					...
					if( pageIndex > 0 )
					{
						ShortcutAndWidgetContainer parent = getCellLayoutChildrenForIndex( workspace , pageIndex - 1 );
						View newIcon = getIconInDirection( layout , parent , parent.getChildCount() , -1 );
						if( newIcon != null )
						{
							newIcon.requestFocus();
