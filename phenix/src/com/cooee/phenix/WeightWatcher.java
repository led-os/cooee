...
public class WeightWatcher extends LinearLayout
{
	...
	public class ProcessWatcher extends LinearLayout
	{
				...
				int pid )
		{
			...
			if( mMemInfo == null )
			{
				if( LauncherDefaultConfig.SWITCH_ENABLE_DEBUG )
					Log.v( "WeightWatcher" , StringUtils.concat( "Missing info for pid " , mPid , ", removing view: " + this ) );
				initViews();
			}
		}
		...
		public void update()
		{
			...
			mText.setText( StringUtils.concat( "(" , mPid , ( mPid == android.os.Process.myPid() ? "/A" /*app*/
			: "/S"/*service*/) , ") up " , getUptimeString() , " P=" , mMemInfo.currentPss , " U=" , mMemInfo.currentUss ) );
