...
public class PagedViewCellLayout extends ViewGroup implements IPage
{
			...
			int defStyle )
	{
		...
		mOriginalCellWidth = mCellWidth = grid.getCellWidthPx();
		mOriginalCellHeight = mCellHeight = grid.getCellHeightPx();
		mCellCountX = (int)grid.getNumColumns();
		mCellCountY = (int)grid.getNumRows();
	...
	public void enableCenteredContent(
			boolean enabled )
	{
	...
	public int[] getCellCountForDimensions(
			int width ,
			int height )
	{
	...
	public int[] estimateCellPosition(
			int x ,
			int y )
	{
	...
	public static class LayoutParams extends ViewGroup.MarginLayoutParams
	{
		...
		{
			return StringUtils.concat( "(" , this.cellX , ", " , this.cellY , ", " , this.cellHSpan , ", " , this.cellVSpan , ")" );
		}
	}
}
