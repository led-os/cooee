 ...
 */
public class PagedViewGridLayout extends GridLayout implements IPage,IEffect
{
...
//	
	...
	public int getChildrenCellX(
			int index )
	{
		return 0/*( (CellLayout.LayoutParams)( getChildrenLayout().getChildAt( index ).getLayoutParams() ) ).cellX*/;
	}
	...
	public int getChildrenCellY(
			int index )
	{
		return 0/*( (CellLayout.LayoutParams)( getChildrenLayout().getChildAt( index ).getLayoutParams() ) ).cellY*/;
	}
