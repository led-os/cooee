...
public class LauncherViewPropertyAnimator extends Animator implements AnimatorListener
{
	...
	public LauncherViewPropertyAnimator translationX(
			float value )
	{
	...
	public LauncherViewPropertyAnimator translationY(
			float value )
	{
	...
	public LauncherViewPropertyAnimator scaleX(
			float value )
	{
	...
	public LauncherViewPropertyAnimator rotationY(
			float value )
	{
	...
	public LauncherViewPropertyAnimator alpha(
			float value )
	{
