...
public class DragView extends View
{
			...
			final float initialScale )
	{
		...
		final float offsetX = LauncherDefaultConfig.getDimensionPixelSize( R.dimen.dragViewOffsetX );
		final float offsetY = LauncherDefaultConfig.getDimensionPixelSize( R.dimen.dragViewOffsetY );
		final float scaleDps = LauncherDefaultConfig.getDimensionPixelSize( R.dimen.dragViewScale );
	...
	public void setDragVisualizeOffset(
			Point p )
	{
