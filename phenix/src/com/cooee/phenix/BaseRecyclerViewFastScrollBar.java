...
public class BaseRecyclerViewFastScrollBar
{
			...
			Resources res )
	{
		...
		mThumbWidth = mThumbMinWidth = LauncherDefaultConfig.getDimensionPixelSize( R.dimen.container_fastscroll_thumb_min_width );
		mThumbMaxWidth = LauncherDefaultConfig.getDimensionPixelSize( R.dimen.container_fastscroll_thumb_max_width );
		mThumbHeight = LauncherDefaultConfig.getDimensionPixelSize( R.dimen.container_fastscroll_thumb_height );
		mThumbCurvature = mThumbMaxWidth - mThumbMinWidth;
		mTouchInset = LauncherDefaultConfig.getDimensionPixelSize( R.dimen.container_fastscroll_thumb_touch_inset );
	}
	...
	private void updateThumbPath()
	{
		...
		mThumbPath.cubicTo( mThumbOffset.x , mThumbOffset.y + mThumbHeight , mThumbOffset.x - mThumbCurvature , mThumbOffset.y + mThumbHeight / 2 , mThumbOffset.x , mThumbOffset.y ); // bl2tl
		mThumbPath.close();
	}
