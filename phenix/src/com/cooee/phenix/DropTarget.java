...
public interface DropTarget
{
	...
	public static class DragEnforcer implements DragController.DragListener
	{
		...
		void onDragEnter()
		{
			...
			if( dragParity != 1 )
			{
				if( LauncherDefaultConfig.SWITCH_ENABLE_DEBUG )
					Log.e( TAG , StringUtils.concat( "onDragEnter: Drag contract violated: " , dragParity ) );
			}
		}
		...
		void onDragExit()
		{
			...
			{
				if( LauncherDefaultConfig.SWITCH_ENABLE_DEBUG )
					Log.e( TAG , StringUtils.concat( "onDragExit: Drag contract violated: " , dragParity ) );
			}
		}
				...
				int dragAction )
		{
			...
			{
				if( LauncherDefaultConfig.SWITCH_ENABLE_DEBUG )
					Log.e( TAG , StringUtils.concat( "onDragStart: Drag contract violated: " , dragParity ) );
			}
		}
		...
		public void onDragEnd()
		{
			...
			{
				if( LauncherDefaultConfig.SWITCH_ENABLE_DEBUG )
					Log.e( TAG , StringUtils.concat( "onDragEnd: Drag contract violated: " , dragParity ) );
			}
		}
	}
	...
	void getHitRectRelativeToDragLayer(
			Rect outRect );
