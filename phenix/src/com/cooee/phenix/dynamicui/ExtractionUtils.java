...
package com.cooee.phenix.dynamicui;
...
public class ExtractionUtils {
    ...
    private static boolean hasWallpaperIdChanged(Context context) {
		...
		final SharedPreferences sharedPrefs = context.getSharedPreferences( "allapps" , Context.MODE_PRIVATE );
    ...
    public static int getWallpaperId(WallpaperManager wallpaperManager) {
        ...
        try {
			...
			return (Integer)getWallpaperId.invoke( wallpaperManager , FLAG_SET_SYSTEM );
		}
		catch( Exception e )
		{
            return -1;
