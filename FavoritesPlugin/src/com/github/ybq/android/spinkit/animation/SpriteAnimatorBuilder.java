...
public class SpriteAnimatorBuilder
{
	...
	public SpriteAnimatorBuilder(
			Sprite sprite )
	{
		this.sprite = sprite;
	}
	
	public SpriteAnimatorBuilder scale(
			float fractions[] ,
			float ... scale )
	{
	...
	public SpriteAnimatorBuilder alpha(
			float fractions[] ,
			int ... alpha )
	{
	...
	public SpriteAnimatorBuilder scaleX(
			float fractions[] ,
			float ... scaleX )
	{
	...
	public SpriteAnimatorBuilder scaleY(
			float fractions[] ,
			float ... scaleY )
	{
	...
	public SpriteAnimatorBuilder rotateX(
			float fractions[] ,
			int ... rotateX )
	{
	...
	public SpriteAnimatorBuilder rotateY(
			float fractions[] ,
			int ... rotateY )
	{
	...
	@SuppressWarnings( "unused" )
	public SpriteAnimatorBuilder translateX(
			float fractions[] ,
			int ... translateX )
	{
	...
	@SuppressWarnings( "unused" )
	public SpriteAnimatorBuilder translateY(
			float fractions[] ,
			int ... translateY )
	{
	...
	public SpriteAnimatorBuilder rotate(
			float fractions[] ,
			int ... rotate )
	{
	...
	public SpriteAnimatorBuilder interpolator(
	...
	public SpriteAnimatorBuilder easeInOut(
			float ... fractions )
	{
	...
	public SpriteAnimatorBuilder duration(
			long duration )
	{
	...
	@SuppressWarnings( "unused" )
	public SpriteAnimatorBuilder repeatCount(
			int repeatCount )
	{
