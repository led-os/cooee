			...
			View v )
	{
		switch( v.getId() )
		{
			case R.id.download_layout_right_button:
				String packageName = getResources().getString( R.string.default_weather_package );
				Log.i( "test" , " WeatherProvider.packageName = " + packageName );
				BaseDownloadHelper.download( DownloadActivity.this.getApplicationContext() , DownloadActivity.this.getApplicationContext() , new BaseDownloadHelper.DownloadListener() {
