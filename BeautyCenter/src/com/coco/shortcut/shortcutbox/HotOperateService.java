...
public class HotOperateService
{
	...
	public static final String TABLE_NAME = "hotOperate";
	...
	public static String getCreateSql()
	{
		String result = String
				.format(
						"CREATE TABLE %s (%s TEXT primary key, %s TEXT, %s INTEGER, %s TEXT, %s INTEGER, %s TEXT," + " %s TEXT, %s TEXT, %s TEXT, %s TEXT, %s TEXT, %s TEXT,%s TEXT, %s INTEGER, %s TEXT," + " %s TEXT, %s TEXT, %s TEXT, %s TEXT, %s TEXT);" ,
						TABLE_NAME ,
						FIELD_PACKAGE_NAME ,
			...
			String packageName )
	{
		...
		try
		{
			cursor = db.query( TABLE_NAME , new String[]{ FIELD_THUMBIMG } , FIELD_PACKAGE_NAME + "=?" , new String[]{ packageName } , null , null , null );
			if( cursor.moveToFirst() )
			{
			...
			String packageName )
	{
		...
		try
		{
			cursor = db.query( TABLE_NAME , new String[]{ FIELD_PREVIEWLIST } , FIELD_PACKAGE_NAME + "=?" , new String[]{ packageName } , null , null , null );
			if( cursor.moveToFirst() )
			{
			...
			String packageName )
	{
		...
		try
		{
			cursor = db.query( TABLE_NAME , new String[]{ FIELD_RESURL } , FIELD_PACKAGE_NAME + "=?" , new String[]{ packageName } , null , null , null );
			if( cursor.moveToFirst() )
			{
