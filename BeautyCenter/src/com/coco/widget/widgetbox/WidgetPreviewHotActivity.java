...
public class WidgetPreviewHotActivity extends Activity
{
			...
			Bundle savedInstanceState )
	{
		...
		btnApply.setOnClickListener( new View.OnClickListener() {
					...
					View v )
			{
				...
				{
					Intent it = new Intent( StaticClass.ADD_WIDGET_TO_LAUNCHER );
				...
				else
				{
					try
					{
						if( isSystemApp( mContext.getPackageManager().getPackageInfo( Information.getPackageName() , 0 ) ) )
						{
							Toast.makeText( mContext , R.string.can_not_uninstall , Toast.LENGTH_SHORT ).show();
						}
						else
						{
							removePackage();
		...
		btnDown.setOnClickListener( new View.OnClickListener() {
			...
			public void onClick(
					View v )
			{
				// @gaominghui2016/01/29 ADD START 友盟统计点击下载插件
				if( FunctionConfig.isUmengStatistics_key() )
				{
					MobclickAgent.onEvent( mContext , "click_download" );
					MobclickAgent.onEvent( mContext , "online_widget_download" );
				}
				// @gaominghui20162016/01/29 ADD END
	...
	protected void onResume()
	{
		...
		if( FunctionConfig.isUmengStatistics_key() )
		{
			//Log.i( LOG_TAG , "WidgetPreviewHotActivity onResume !!!" );
			MobclickAgent.onPageStart( "WidgetPreviewHotActivity" );
	...
	protected void onPause()
	{
		...
		if( FunctionConfig.isUmengStatistics_key() )
		{
			//Log.i( LOG_TAG , "WidgetPreviewHotActivity onPause !!!" );
			MobclickAgent.onPageEnd( "WidgetPreviewHotActivity" );
			...
			boolean reloadGallery )
	{
		...
		if( Information.isInstalled( this ) )
		{
			...
			if( reloadGallery )
			{
				galleryPreview.setAdapter( new WidgetPreviewLocalAdapter( this , packageName , dstContext , destContent ) );
			}
	...
	private void removePackage()
	{
		...
		if( FunctionConfig.isUmengStatistics_key() )
		{
			MobclickAgent.onEvent( mContext , "online_widget_uninstall" );
		}
		// @gaominghui20162016/01/29 ADD END
