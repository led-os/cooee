...
public class Assets
{
	...
	public static String LAUNCHER_PROVIDER_AUTHOR = "com.iLoong.launcher.pub.provider";
	...
	public static void setLauncherAuthor(
			String author )
	{
		if( author != null )
		{
			LAUNCHER_PROVIDER_AUTHOR = author;
			Log.v( "Assets" , "LAUNCHER_PROVIDER_AUTHOR == " + LAUNCHER_PROVIDER_AUTHOR );
		}
	}
			...
			Context context )
	{
		...
		try
		{
			Context remoteContext = mContext.createPackageContext( ThemesDB.LAUNCHER_UNI_PACKAGENAME , Context.CONTEXT_IGNORE_SECURITY );
			AssetManager assetManager = remoteContext.getAssets();
			InputStream inputStream = assetManager.open( CONFIG_FILE_NAME );
			String text = readTextFile( inputStream );
			JSONObject jObject = new JSONObject( text );
		...
		if( com.coco.theme.themebox.util.FunctionConfig.isNetVersion() )
			...
			uri = Uri.parse( "content://" + LAUNCHER_PROVIDER_AUTHOR + "/" + "config" );
			...
			String name )
	{
		...
		if( com.coco.theme.themebox.util.FunctionConfig.isNetVersion() )
			...
			uri = Uri.parse( "content://" + LAUNCHER_PROVIDER_AUTHOR + "/" + "effect" );
		String[] projection = null;
		String selection = null;
		String[] selectionArgs = null;
		String sortOrder = null;
			...
			String name )
	{
		...
		{
			uri = Uri.parse( "content://" + LAUNCHER_PROVIDER_AUTHOR + "/" + "theme" );
		}
		String[] projection = null;
		String selection = null;
		String[] selectionArgs = null;
		...
		//Log.i( "minghui" , "query result theme = " + theme );
		return theme;
	}
			...
			String name )
	{
		...
		if( com.coco.theme.themebox.util.FunctionConfig.isNetVersion() )
			...
			uri = Uri.parse( "content://" + LAUNCHER_PROVIDER_AUTHOR + "/" + "scene" );
		String[] projection = null;
		String selection = null;
		String[] selectionArgs = null;
		String sortOrder = null;
	...
	public static String getHWWallpaper(
			Context context ,
			String name )
	{
		ContentResolver resolver = context.getContentResolver();
		Uri uri = Uri.parse( "content://" + "com.iLoong.launcherHW3X.pub.provider" + "/" + "wallpaper" );
		String[] projection = null;
		String selection = null;
		String[] selectionArgs = null;
		String sortOrder = null;
			...
			String name )
	{
		...
		if( com.coco.theme.themebox.util.FunctionConfig.isNetVersion() )
			...
			uri = Uri.parse( "content://" + LAUNCHER_PROVIDER_AUTHOR + "/" + "wallpaper" );
		String[] projection = null;
		String selection = null;
		String[] selectionArgs = null;
		String sortOrder = null;
