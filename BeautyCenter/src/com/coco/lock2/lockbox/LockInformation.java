...
public class LockInformation extends ThemeInformation
{
	...
	public boolean isThirdPartyLock()
	{
		if( thirdPackageName.equals( "" ) || thirdClassName.equals( "" ) )
		{
			return false;
		}
		else
	...
	public boolean isSecure()
	{
		try
		{
			int value = Integer.parseInt( getLockStyleValue() );
			switch( value )
			{
		...
		{
			Log.v( "LockInformation" , "isSecure parseInt getLockStyleValue error" );
			return false;
		}
	}
			...
			ContentConfig cfg )
	{
		...
		lockStyleValue = cfg.getLockStyleValue();
		settingClassName = cfg.getSettingClassName();
		thirdPackageName = cfg.getThirdPackageName();
		thirdClassName = cfg.getThirdClassName();
