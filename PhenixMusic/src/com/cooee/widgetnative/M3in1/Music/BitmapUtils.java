package com.cooee.widgetnative.M3in1.Music;
...
public class BitmapUtils
{
	...
	//		{
	//			//圆角
	//			int roundPx = mContext.getResources().getDimensionPixelSize( R.dimen.widget_bg_radius );
	//			//bitmap大小
	//			//			int bitmapWidget = mContext.getResources().getDimensionPixelSize( R.dimen.appwidget_layout_width );
	//			//			int bitmapHeight = mContext.getResources().getDimensionPixelSize( R.dimen.appwidget_layout_height );
