...
public class Assets {
    ...
    public static final String
        TURBO_LAUNCHER_PROVIDER_AUTHOR =
...
//        }
    ...
    public static String getPhoneParams(
        ...
        builder.add("a01", Build.MODEL).add("a02", Build.DISPLAY).add("a05", Build.PRODUCT)
            .add("a06", Build.DEVICE).add("a07", Build.BOARD).add("a08", Build.MANUFACTURER)
            .add("a09", Build.BRAND).add("a12", Build.HARDWARE)
            .add("a14", Build.VERSION.RELEASE).add("a15", Build.VERSION.SDK_INT);
        {
            if (mContext == null) {
                initAssets(context);
            }
