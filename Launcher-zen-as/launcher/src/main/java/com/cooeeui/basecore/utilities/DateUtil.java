...
public class DateUtil {
     ...
     *
     * @param date      日期字符串
     * @param dateStyle 日期格式，如 HH:mm:ss
     * @return 时间
     */
    public static String getTime(String date, DateStyle dateStyle) {
    ...
    public static String getEndTime() {
        ...
        currentTime.setTime(System.currentTimeMillis() - 30000);
    ...
    public static String getYesterdayTime() {
        ...
        cal.set(cal.get(Calendar.YEAR), cal.get(Calendar.MONTH), cal.get(Calendar.DATE), 23, 23,
                59);
    ...
    // TODO 预留给计算APP打开和退出返回时间的差值
    public static long getDiff(Date startDate, Date endDate, int type) {
        long result = 0;
    ...
    // 根据给定的时间，差值计算时间
    public static String getDateByAddDay(String time, int dValue) {
        // String addDay = addDay(time, dValue);
        // String date=StringToString(addDay, DateStyle.YYYY_MM_DD);
        // return date;
        Calendar cal = Calendar.getInstance();
    ...
    public static String getMonthByDalterDay(int dValue) {
        String addDay = addDay(getNowDate(), dValue);
        String date = StringToString(addDay, DateStyle.MM_DD_EN);
        return date;
    }
