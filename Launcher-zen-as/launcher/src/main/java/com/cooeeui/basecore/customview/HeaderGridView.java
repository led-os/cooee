...
package com.cooeeui.basecore.customview;
...
/**
 * A {@link GridView} that supports adding header rows in a very similar way to {@link
 * android.widget.ListView}. See {@link HeaderGridView#addHeaderView(View, Object, boolean)} See
...
public class HeaderGridView extends GridView {
    ...
    private static class HeaderViewGridAdapter implements WrapperListAdapter, Filterable {
         ...
         * but since getCount() includes the headers and footers, specialized adapters might want a
         * different behavior.
         */
        @Override
