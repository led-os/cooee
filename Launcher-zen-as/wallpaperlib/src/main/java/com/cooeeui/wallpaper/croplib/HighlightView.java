...
public class HighlightView {
    ...
    private static final float
        ...
        (DEFAULT_CORNER_THICKNESS_DP / 2) - (DEFAULT_LINE_THICKNESS_DP / 2);
    ...
    /**
     * 设置浮于图片上方的透明框框的大小和属性值
     *
     * @param m                   矩阵值
     * @param imageRect           图片资源的矩形
     * @param cropRect            切图的大小矩阵
     * @param maintainAspectRatio 是否按照比例
     */
...
//        canvas.drawCircle(xMiddle, drawRect.bottom, handleRadius, handlePaint);
    ...
    private void drawCorners(Canvas canvas) {
        ...
        final float bottom = drawRect.bottom;
