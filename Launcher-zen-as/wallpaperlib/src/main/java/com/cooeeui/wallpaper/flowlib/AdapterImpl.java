...
import com.cooeeui.wallpaperonline.R;
...
final class AdapterImpl implements View.OnClickListener, View.OnLongClickListener {
    ...
    private final Map<Integer, ObjectPool<AsymmetricViewHolder<?>>>
        viewHoldersMap =
        new ArrayMap<>();
    ...
    void onBindViewHolder(ViewHolder holder, int position, ViewGroup parent) {
        ...
        if (debugEnabled && position % 20 == 0) {
            ...
            for (Map.Entry<Integer, ObjectPool<AsymmetricViewHolder<?>>> e : viewHoldersMap
                .entrySet()) {
