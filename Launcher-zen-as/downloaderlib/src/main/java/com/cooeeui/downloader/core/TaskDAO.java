...
import static com.cooeeui.downloader.core.DLCons.DBCons.TB_TASK;
import static com.cooeeui.downloader.core.DLCons.DBCons.TB_TASK_CURRENT_BYTES;
import static com.cooeeui.downloader.core.DLCons.DBCons.TB_TASK_DIR_PATH;
import static com.cooeeui.downloader.core.DLCons.DBCons.TB_TASK_DISPOSITION;
import static com.cooeeui.downloader.core.DLCons.DBCons.TB_TASK_ETAG;
import static com.cooeeui.downloader.core.DLCons.DBCons.TB_TASK_FILE_NAME;
import static com.cooeeui.downloader.core.DLCons.DBCons.TB_TASK_LOCATION;
import static com.cooeeui.downloader.core.DLCons.DBCons.TB_TASK_MIME_TYPE;
import static com.cooeeui.downloader.core.DLCons.DBCons.TB_TASK_TOTAL_BYTES;
import static com.cooeeui.downloader.core.DLCons.DBCons.TB_TASK_URL_BASE;
import static com.cooeeui.downloader.core.DLCons.DBCons.TB_TASK_URL_REAL;
    ...
    public void updateTaskInfo(DLInfo info) {
        ...
        db.execSQL("UPDATE " + TB_TASK + " SET " +
                   ...
                   TB_TASK_URL_BASE + "=?", new Object[]{info.disposition, info.location,
                                                         info.mimeType, info.totalBytes,
                                                         info.fileName, info.currentBytes,
                                                         info.baseUrl});
        db.close();
    }
