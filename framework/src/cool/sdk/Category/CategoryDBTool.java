...
public class CategoryDBTool
{
			...
			int id )
	{
		...
		{
			SQLiteDatabase db = CategorydbHelper.getWritableDatabase();
			Cursor c = db.query( TREE_TABLE , null , StringUtils.concat( "id=" , id ) , null , null , null , null );
			if( c.moveToFirst() )
			{
				db.update( TREE_TABLE , values , StringUtils.concat( "id=" , id ) , null );
			}
			else
			{
			...
			String pkgName )
	{
		...
		{
			SQLiteDatabase db = CategorydbHelper.getWritableDatabase();
			Cursor c = db.query( CATEINFO_TABLE , null , StringUtils.concat( "pn='" , pkgName , "'" ) , null , null , null , null );
			if( c.moveToFirst() )
			{
				db.update( CATEINFO_TABLE , values , StringUtils.concat( "pn='" , pkgName , "'" ) , null );
			}
			else
			{
			...
			int id )
	{
		...
		{
			SQLiteDatabase db = CategorydbHelper.getWritableDatabase();
			Cursor c = db.query( DICT_TABLE , null , StringUtils.concat( "idc=" , id ) , null , null , null , null );
			if( c.moveToFirst() )
			{
				db.update( DICT_TABLE , values , StringUtils.concat( "idc=" , id ) , null );
			}
			else
			{
			...
			String pkgName )
	{
		...
		{
			SQLiteDatabase db = CategorydbHelper.getWritableDatabase();
			Cursor c = db.query( RECOMMEDINFO_TABLE , null , StringUtils.concat( "apk_pn='" , pkgName , "'" ) , null , null , null , null );
			if( c.moveToFirst() )
			{
				db.update( RECOMMEDINFO_TABLE , values , StringUtils.concat( "apk_pn='" , pkgName , "'" ) , null );
			}
			else
			{
			...
			int id )
	{
		...
		{
			SQLiteDatabase db = CategorydbHelper.getWritableDatabase();
			db.delete( DICT_TABLE , StringUtils.concat( "id=" , id ) , null );
			db.close();
		}
	}
			...
			int id )
	{
		...
		{
			SQLiteDatabase db = CategorydbHelper.getWritableDatabase();
			db.delete( TREE_TABLE , StringUtils.concat( "id=" , id ) , null );
			db.close();
		}
	}
			...
			String pkgName )
	{
		...
		{
			SQLiteDatabase db = CategorydbHelper.getWritableDatabase();
			db.delete( CATEINFO_TABLE , StringUtils.concat( "apk_pn='" , pkgName , "'" ) , null );
			db.close();
		}
	}
			...
			String pkgName )
	{
		...
		{
			SQLiteDatabase db = CategorydbHelper.getWritableDatabase();
			db.delete( CATEINFO_TABLE , StringUtils.concat( "pn='" , pkgName , "'" ) , null );
			db.close();
		}
	}
			...
			int IDindex )
	{
		synchronized( syncObj )
		{
			...
			Cursor c = db.query( DICT_TABLE , null , StringUtils.concat( "id=" , IDindex ) , null , null , null , null );
			if( c.moveToFirst() )
			{
			...
			int IDindex )
	{
		...
		{
			SQLiteDatabase db = CategorydbHelper.getReadableDatabase();
			Cursor c = db.query( TREE_TABLE , null , StringUtils.concat( "id=" , IDindex ) , null , null , null , null );
			if( c.moveToFirst() )
			{
			...
			String pkgName )
	{
		...
		{
			SQLiteDatabase db = CategorydbHelper.getReadableDatabase();
			Cursor c = db.query( RECOMMEDINFO_TABLE , new String[]{ "f_id" } , "apk_pn = ?" , new String[]{ pkgName } , null , null , null );
			int f_id = CategoryConstant.UN_KNOW;
			if( c.moveToNext() )
				f_id = c.getInt( c.getColumnIndexOrThrow( "f_id" ) );
			c.close();
			db.close();
			return f_id;
		}
	...
	public void getAllRecommendInfo()
	{
		...
		synchronized( syncObj )
		{
			...
			while( c.moveToNext() )
			{
				...
				int apk_type = c.getInt( c.getColumnIndexOrThrow( "apk_type" ) );
				...
				String f_webLinkPkg = c.getString( c.getColumnIndexOrThrow( "f_webLinkPkg" ) );
				String f_linkAddr = c.getString( c.getColumnIndexOrThrow( "f_linkAddr" ) );
				RecommendApkInfo apkInfo = new RecommendApkInfo(
						apk_pn ,
						apk_type ,
						apk_dlinfo ,
						apk_vc ,
