...
public class DatabaseHelper extends SQLiteOpenHelper
{
			...
			SQLiteDatabase db )
	{
		...
		db.execSQL( "CREATE TABLE IF NOT EXISTS recommend_info (fidiid_key varchar(255) primary key, apk_pn varchar(255), apk_type integer,apk_dlinfo text, apk_vc text, apk_vn text, apk_size integer, apk_cn text, apk_en text, apk_fn text, apk_iconpath text, apk_flag integer, f_id integer, f_type char(4), f_en text, f_cn text, f_fn text, f_webLinkPkg text, f_linkAddr text)" );
	}
