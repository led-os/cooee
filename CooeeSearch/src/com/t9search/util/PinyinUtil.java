...
import com.cooee.pinyin4j.net.sourceforge.pinyin4j.format.HanyuPinyinOutputFormat;
import com.cooee.pinyin4j.net.sourceforge.pinyin4j.format.HanyuPinyinToneType;
import com.cooee.pinyin4j.net.sourceforge.pinyin4j.format.exception.BadHanyuPinyinOutputFormatCombination;
...
public class PinyinUtil
{
	 ...
	 * @param pinyinUnit
	 */
	public static void chineseStringToPinyinUnit(
	...
	private static void addPinyinUnit(
			List<PinyinUnit> pinyinUnit ,
			PinyinUnit pyUnit ,
			boolean pinyin ,
			String[] string ,
	...
	private static void initPinyinUnit(
			...
			int startPosition )
	{
		...
		{ //more than one pinyin.//we must delete the same pinyin string,because pinyin without tone.
			t9PinyinUnit = new T9PinyinUnit();
	...
	private static void initT9PinyinUnit(
			T9PinyinUnit t9PinyinUnit ,
			String pinyin )
	{
