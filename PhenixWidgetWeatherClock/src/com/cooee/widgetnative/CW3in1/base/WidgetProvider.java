...
public class WidgetProvider extends AppWidgetProvider
{
	...
	public static final String CLICK_CLOCK_LAYOUT = "com.cooee.widgetnative.CW3in1.click.clock_layout";
	public static final String CLICK_WEATHER_LAYOUT = "com.cooee.widgetnative.CW3in1.click.weather_layout";
	public static final String CLICK_DATE_LAYOUT = "com.cooee.widgetnative.CW3in1.click.date_layout";
			...
			Intent intent )
	{
		...
		mWidgetManager.onClick( intent.getAction() );
		mWidgetManager.updateAppWidget();
	}
