...
public class localConfigureActivity extends Activity
{
			...
			Bundle savedInstanceState )
	{
		...
		// 获得widgetId
		mWidgetId = getIntent().getIntExtra( AppWidgetManager.EXTRA_APPWIDGET_ID , mWidgetId );
		...
		mContext = this;
		intent.setClassName( "com.cooee.weather" , "com.cooee.weather.WeatherEditPost" );
		startActivityForResult( intent , CONTEXT_RESTRICTED );
	}
	
	public void setConfigureResult(
			int resultCode )
	{
