package com.cooee.widgetnative.P3in1.Photo.activity;
...
import com.cooee.widgetnative.P3in1.base.WidgetManager;
...
public class PickPicDialogActivity extends Activity implements View.OnClickListener
{
	...
	//
	public static final String INTENT_REQUEST = "intent_request_photo";
	public static final int PICTURE = 10113;
	public static final int ALBUM = 10114;
			...
			android.os.Bundle savedInstanceState )
	{
		...
		WidgetManager mWidgetManager = WidgetManager.getInstance( getApplication() );
		mWidgetManager.isOpenActivity = false;
		mIfShowViewImg = mWidgetManager.ifShowViewImg();
		...
		if( !mWidgetManager.isShowChooseAlbum() )
		{
		...
		{
			showViewItem();
			setCurUri( mWidgetManager.getCurUri() );
		}
			...
			View v )
	{
		...
		switch( v.getId() )
		{
			case R.id.dialog_choose_album://相册
			...
			android.content.Intent data )
	{
		...
		if( data != null )
		{
			...
			{
				case PICTURE:
					broadIntent.putExtra( WidgetManager.PICTURE_URI , data.getDataString() );
					break;
				default:
					break;
			}
			broadIntent.putExtra( INTENT_REQUEST , requestCode );
			Log.d( "" , "cyk onActivityResult broadIntent: " + broadIntent );
			WidgetManager.getInstance( this ).setChangeImageIntent( broadIntent );
		}
		finish();
	}
}
