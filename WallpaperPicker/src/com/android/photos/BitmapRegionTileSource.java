...
class SimpleBitmapRegionDecoderWrapper implements SimpleBitmapRegionDecoder
{
	...
	private SimpleBitmapRegionDecoderWrapper(
...
class DumbBitmapRegionDecoder implements SimpleBitmapRegionDecoder
{
	...
	private DumbBitmapRegionDecoder(
			Bitmap b )
	{
		mBuffer = b;
	}
...
public class BitmapRegionTileSource implements TiledImageRenderer.TileSource
{
	...
	public static abstract class BitmapSource
	{
		...
		public abstract boolean readExif(
				ExifInterface ei );
		
		public abstract SimpleBitmapRegionDecoder loadBitmapRegionDecoder();
		
		public abstract Bitmap loadPreviewBitmap(
				BitmapFactory.Options options );
	}
	...
	private static Bitmap ensureGLCompatibleBitmap(
			Bitmap bitmap )
	{
