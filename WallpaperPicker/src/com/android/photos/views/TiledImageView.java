...
public class TiledImageView extends FrameLayout
{
	...
	private static final boolean IS_SUPPORTED = Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1;//zhujieping,这里改成大于15（原先大于16），验证下来没有问题
	...
	private void updateScaleIfNecessaryLocked(
			ImageRendererWrapper renderer )
	{
	...
	private void invalOnVsync()
	{
		...
		{
			mInvalPending = true;
			FrameCallback mFrameCallback = new FrameCallback() {
