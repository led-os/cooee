...
public class ClockManager
{
	...
	/**
	 * @see com.cooee.widgetnative.ALL3in1.ClockWeather.timer.ClockTimerListener#clockTimeChanged()
	...
	public void clockTimeChanged()
	{
		...
		Log.d( TAG , "cyk clockTimeChanged mCurrentHour: " + mCurrentHour + " mCurrentMinute: " + mCurrentMinute );
	}
	...
	public void updateClockView()
	{
		...
		mDay = mCurrentDay;
		UpdateDateView( mRemoteViews );
		mHour = mCurrentHour;
		UpdateHourView( mRemoteViews );
		mMinute = mCurrentMinute;
		UpdateMinuteView( mRemoteViews );
	}
